...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="{{url('new/head')}}"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="{{url('new/left')}}" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="{{url('new/main')}}" name="main" scrolling="yes" noresize="noresize"
